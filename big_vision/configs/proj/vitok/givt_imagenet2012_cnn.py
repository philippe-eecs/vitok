...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(arg, res=RES, patch_size=PATCH_SIZE, style='ar',  # 'ar' or 'masked'
                       model_size='default', vae_file='givt/vae_imagenet_2012_beta_5e-5_params', runlocal=False, singlehost=False,
                       adaptor=False)
  ...
  config.input.batch_size = 4096 if not arg.runlocal else 8
  ...
  config.vae.model_init = 'gs://us-central2-b/' + arg.vae_file
  if "vae_imagenet_2012_beta_5e-5_params" in arg.vae_file:
